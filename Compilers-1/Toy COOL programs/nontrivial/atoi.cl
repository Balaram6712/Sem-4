class Main inherits IO{
	...
	main () : Object{{
		...
		s <- in_string();
		n <- atoi(s);
		out_string("Tne integer given as input: ").out_int(n);
		out_string("\n");
	}};
};				--implementation of atoi function which takes string as input and converts into input when integre given as input 